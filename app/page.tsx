              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
                 ...
                 <div className="space-y-6 md:space-y-8 lg:pl-10 order-1 lg:order-2">
                    <div>
                      ...
                      <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-black text-brand-950 dark:text-white uppercase italic leading-[1.1] md:leading-none">The Regional Backbone <br className="hidden md:block"/>Of Construction.</h2>
                    </div>
                    ...
                    <div className="pt-4 md:pt-6">
                      <Link href="/about">
                         <Button variant="outline" className="w-full sm:w-auto h-14 md:h-16 px-10 md:px-12 border-brand-950 dark:border-white hover:bg-brand-950 hover:text-white dark:hover:bg-white dark:hover:text-brand-950 transition-all font-black uppercase tracking-widest">
                 ...
                 {solutionsGrid.map((item, i) => (
                    <div key={i} className="group relative aspect-square overflow-hidden bg-brand-950 border border-industrial-200 dark:border-brand-800">
                       ...
                       <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 text-left z-10">
                          <h4 className="text-xl md:text-2xl font-display font-black text-white uppercase italic leading-none drop-shadow-lg">{item.title}</h4>
                          {item.sub && (
        ...
        <section className="py-16 md:py-24 bg-industrial-50/50 dark:bg-brand-900/30 backdrop-blur-md border-y border-industrial-100 dark:border-brand-800">
          <div className="container mx-auto px-4 md:px-6 max-w-4xl">
             <div className="text-center mb-12 md:mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-display font-black text-brand-950 dark:text-white uppercase italic leading-none">FREQUENTLY ASKED <br/>QUESTIONS</h2>
             </div>
             ...
             <div className="space-y-4">
                {[
                  ...
                  { q: "DO YOU PROVIDE TECHNICAL SUBMITTALS AND CAD DRAWINGS?", a: "Yes, we provide full technical support for consultants and contractors, including shop drawings, CAD files, and material certificates for every batch." }
                   ...
                   <div key={i} className="bg-white/40 dark:bg-brand-950/40 backdrop-blur-md border border-white/20 dark:border-brand-800/50">
                     <AccordionItem 
                      title={faq.q} 
                      isOpen={openFaq === i} 
           ...
           <div className="container mx-auto px-4 md:px-6">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-start">
                    ...
                    <div className="space-y-6 md:space-y-8">
                       {[
                        ...
                        <div key={i} className="flex gap-4 md:gap-6 items-center group">
                          ...
                          <div>
                             <p className="text-[10px] font-black uppercase text-industrial-400 tracking-widest leading-none mb-1">{item.label}</p>
                             <p className="text-base md:text-xl font-display font-black text-brand-950 dark:text-white uppercase italic">{item.val}</p>
                          </div>
                        </div>
                       ))}
                    </div>
                 ...
                 <div className="lg:col-span-7 bg-brand-950/90 backdrop-blur-2xl p-8 md:p-12 lg:p-20 shadow-[0_30px_100px_rgba(0,0,0,0.5)] border border-white/5 relative overflow-hidden">
                    ...
                    <h3 className="text-2xl md:text-3xl font-display font-black text-white uppercase italic mb-8 md:mb-10 leading-none drop-shadow-md">Engineering Request</h3>
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                       <div className="space-y-2">
                          ...
                          <Input className="bg-white/5 backdrop-blur-md border-white/10 text-white h-12 md:h-14 focus:bg-white/10 placeholder:text-stone-700" placeholder="e.g. John Doe" />
                       </div>
                       <div className="space-y-2">
