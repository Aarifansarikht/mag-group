...
import { ShieldCheck, Factory, Globe, MapPin } from "lucide-react";
        ...
        <section className="relative h-[50vh] md:h-[60vh] flex items-center bg-brand-950">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-stone-400 max-w-2xl mx-auto font-medium text-sm md:text-base px-4">
              Dual hubs in Doha and Dubai delivering world-class engineering precision for the modern Middle East.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <p className="text-base md:text-lg text-industrial-600 dark:text-stone-400 leading-relaxed font-medium">
                  MAG Group International is a GCC-focused building materials and construction solutions company with a
                  strong manufacturing and engineering foundation. Operating across Doha and Dubai, we support complex
                  construction projects by delivering technically driven, project-specific solutions aligned with
                  international standards.
                </p>

                <p className="text-sm md:text-base text-industrial-500 font-medium leading-relaxed">
                  We are more than a trading organization. Our operations are built around in-house manufacturing,
                  customization, strict quality control, and engineering coordination. This integrated approach allows
                  us to meet consultant specifications, contractor demands, and evolving project requirements with
                ...
                <div className="pt-4">
                  ...
                  <p className="text-sm md:text-base text-industrial-500 font-medium leading-relaxed">
                    We work closely with consultants, developers, and EPC contractors from early-stage technical
                    consultation through manufacturing and delivery. Our role is to simplify execution, ensure
                    compliance, and provide long-term value across commercial, industrial, and infrastructure
                    developments.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {/* Image 2 */}
                <div className="relative w-full h-64 md:h-80 mt-8 md:mt-12 shadow-2xl overflow-hidden">
                  <Image
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
              ...
              <div className="p-8 md:p-12 bg-white dark:bg-brand-950 border-t-4 border-brand-accent shadow-xl">
                ...
                <h3 className="text-2xl md:text-3xl font-display font-black uppercase italic mb-4">MAG Qatar Hub</h3>
                <p className="text-industrial-500 font-medium text-sm leading-relaxed mb-6">
                  Our Doha hub operates as a core manufacturing and engineering center, supporting large-scale
                  infrastructure and government projects. The facility enables controlled production, testing, and full
                  compliance with regional authority standards.
                </p>
              ...
              <div className="p-8 md:p-12 bg-white dark:bg-brand-950 border-t-4 border-brand-950 dark:border-white shadow-xl">
                ...
                <h3 className="text-2xl md:text-3xl font-display font-black uppercase italic mb-4">DMAG UAE Hub</h3>
                <p className="text-industrial-500 font-medium text-sm leading-relaxed mb-6">
                  Strategically located in Jebel Ali, our UAE hub enables rapid project execution, regional logistics,
                  and engineering support across the GCC, ensuring flexibility, speed, and consistent delivery
                  standards.
                </p>
