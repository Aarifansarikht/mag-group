      ...
      <div className="container mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 md:gap-4 group">
          <div className="flex flex-col text-right border-r border-brand-accent/30 pr-3 md:pr-4">
            <span className="text-sm md:text-lg font-display font-black text-brand-950 dark:text-white leading-none">
              مجموعة ماج
            </span>
            <span className="text-[7px] md:text-[8px] font-bold text-brand-accent uppercase tracking-widest mt-1">
              الدولية
            </span>
          </div>
          <div className="flex flex-col">
            <span className="text-lg md:text-2xl font-display font-black tracking-tighter text-brand-950 dark:text-white uppercase leading-none italic">
              MAG <span className="text-brand-accent">GROUP</span>
            </span>
            <span className="text-[8px] md:text-[10px] font-bold text-industrial-500 uppercase tracking-widest leading-none mt-1">
              International
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link href="/contact" className="hidden md:block">
            <Button
              size="sm"
              className="bg-orange-600 text-white hover:bg-orange-700 h-10 px-8 rounded-none tracking-widest border-none shadow-lg"
            >
              CONTACT
            </Button>
          </Link>
          ...
          >
            {isMenuOpen ? (
              <X className="h-5 w-5 text-brand-950 dark:text-white" />
            ) : (
              <Menu className="h-5 w-5 text-brand-950 dark:text-white" />
            )}
          </button>
        </div>
      </div>
        ...
        <div className="h-full flex flex-col p-8 md:p-12 overflow-y-auto">
          ...
          <div className="flex justify-between items-center mb-16 pt-2">
            <Link href="/" onClick={() => setIsMenuOpen(false)}>
              <div className="flex flex-col">
                <span className="text-2xl font-display font-black text-brand-950 dark:text-white italic">
                  MAG <span className="text-brand-accent">GROUP</span>
                </span>
                <span className="text-[10px] font-bold text-industrial-400 dark:text-stone-500 uppercase tracking-widest -mt-1">
                  International Hub
                </span>
              </div>
            </Link>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-10">
              <div className="space-y-4">
                <p className="text-[10px] font-black text-industrial-400 dark:text-stone-500 uppercase tracking-widest italic border-b border-brand-accent inline-block pb-1">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex gap-4">
                  {[Linkedin, Instagram, Facebook].map((Icon, i) => (
                    <button
                      key={i}
                      className="w-12 h-12 flex items-center justify-center border border-industrial-200 dark:border-brand-800/50 bg-white dark:bg-brand-900/50 hover:bg-brand-accent hover:border-brand-accent hover:text-white transition-all text-brand-950 dark:text-white shadow-sm"
                    >
            ...
            <p className="text-[8px] font-bold text-industrial-400 dark:text-stone-600 uppercase tracking-[0.3em] mt-4">
              © 2026 MAG GROUP INTERNATIONAL • QUALITY DRIVEN ENGINEERING
            </p>
          </div>
        </div>
      </div>
