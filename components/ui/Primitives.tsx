      ...
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center rounded-none text-xs font-black uppercase tracking-[0.2em] transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-950 disabled:pointer-events-none disabled:opacity-50",
          {
            ...
            "border-2 border-industrial-200 dark:border-industrial-800 bg-transparent hover:border-brand-950 hover:text-brand-950 dark:hover:border-white dark:hover:text-white text-industrial-900 dark:text-industrial-100":
              variant === "outline",
            "hover:bg-industrial-100 hover:text-brand-950 dark:hover:bg-industrial-800 dark:hover:text-white":
              variant === "ghost",
        ...
        <span
          className={cn(
            ...
            isOpen
              ...
              : "text-industrial-600 dark:text-industrial-400 group-hover:text-brand-950 dark:group-hover:text-white"
          )}
        >
          {title}
        </span>
